...
function evaluateExpression(expression) {
    ...
    while (expressionArray.indexOf('+') !== -1) {
        const currentIndex = expressionArray.indexOf('+');
        const ans = parseInt(expressionArray[currentIndex - 1]) + parseInt(expressionArray[currentIndex + 1]);
        expressionArray[currentIndex + 1] = ans;
        expressionArray.splice(currentIndex - 1, 2);
    }
    let i = 1;
