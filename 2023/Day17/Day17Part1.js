...
function getAvailableDirections(direction, numTimes) {
    switch (direction) {
        case 'right':
            return numTimes === 3 ? ['down', 'up'] : ['right', 'down', 'up'];
        case 'down':
            return numTimes === 3 ? ['left', 'right'] : ['left', 'right', 'down'];
        case 'left':
            return numTimes === 3 ? ['up', 'down'] : ['left', 'up', 'down'];
        case 'up':
            return numTimes === 3 ? ['right', 'left'] : ['right', 'left', 'up'];
    }
}
