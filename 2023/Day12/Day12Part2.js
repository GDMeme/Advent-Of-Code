...
for (const line of arr) {
    ...
    const repeatedSprings = new Array(5).fill(springs).join('?');
    const repeatedGroups = new Array(5).fill(groups).flat();
    
    ans += findCombinations(repeatedSprings, repeatedGroups)
}
