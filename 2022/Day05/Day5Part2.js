...
for (let i = 10; i < arr.length; i++) {
    ...
    newArray[thirdNumber - 1] = newArray[secondNumber - 1].slice(0, firstNumber) + newArray[thirdNumber - 1];
    newArray[secondNumber - 1] = newArray[secondNumber - 1].substring(firstNumber);
}
solution = '';
